 ...
 * @brief   This is the "Example 4.3 Experimenting with priorities" from the Mastering the FreeRTOS Real Time Kernel v1.0 document,
 *          The scheduler always selects the highest priority task that can run, Task 2 has a higher priority than Task 1 and can
 *          always run (running state), therefore the scheduler always selects Task 2, and Task 1 never executes (not running state).
