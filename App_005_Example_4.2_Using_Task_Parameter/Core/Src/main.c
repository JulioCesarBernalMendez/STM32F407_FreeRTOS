 ...
 * @brief   This is the "Example 4.2 Using the task parameter" from the Mastering the FreeRTOS Real Time Kernel v1.0 document,
 *          Unlike Example 4.1, it removes the duplication of task1 and task 2 by creating two instances of a single task and
 *          uses the task parameter of xTaskCreate() to pass the string into each instance.
...
int main(void)
{
  ...
  /* Create the other task in exactly the same way.
     ...
     Two instances of the same task definitions are being created */
