 ...
 * @brief   This is the "Example 4.5 Converting the example tasks to use xTaskDelayUntil" from the
 *          Mastering the FreeRTOS Real Time Kernel v1.0 document.
 * 
 *          Using vTaskDelay() does not guarantee that the frequency at which tasks run is fixed, as the
 *          time at which they leave the Blocked state is relative to when they call vTaskDelay().
 *          Convering the tasks to use xTaskDelayUntil() instead of vTaskDelay() solves this problem.
 * 
